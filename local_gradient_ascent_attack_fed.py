    ...
    for ep in range(epoch):
        ...
        for client_id in active_clients:
            ...
            if client_id == target_cid and ep == 1:
                ...
                attacker.craft_local_parameters(client)
                print("The local parameters have been crafted.")
            if client_id == target_cid and ep == 2:
                print("local gradient ascent attack on cid: {} in fed-epoch: {}".format(client_id, (ep + 1)))
